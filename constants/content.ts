...
export const META_DESCRIPTION =
  "Clear as many blocks before the time runs out. Share your streaks with friends and family!";
...
// Mode content
export const EASY_MODE_TITLE = "Easy";
...
export const MISCELLANEOUS_SETTINGS_TITLE = "Misc. Settings";
